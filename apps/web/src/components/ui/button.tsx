  ...
  'ring-offset-background focus-visible:ring-ring/60 ease-lux inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 active:translate-y-px disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        lime: 'bg-lime text-lime-foreground shadow-soft hover:shadow-card hover:brightness-[1.03]',
        secondary:
          'bg-secondary text-secondary-foreground shadow-soft hover:bg-secondary/90 hover:shadow-card',
        outline:
          'border-input bg-card hover:border-primary/40 hover:bg-accent hover:text-accent-foreground shadow-xs border',
