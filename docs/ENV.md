...
| ------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `OPENAI_API_KEY`                                                                                                                | conversation digests fall back to an extractive summary, memory notes are stored without an embedding, and retrieval runs on Spanish full-text alone. The agent still answers: its own model call routes through the AI Gateway.                                                                                                                                                                                                                                                              |
...
| `AI_GATEWAY_API_KEY`                                                                                                            | the eve agent's model call. Unset is fine on Vercel, where project OIDC authenticates the Gateway instead. Unset **and** off Vercel: **the agent answers nothing** and every guest thread goes to `needs_host`                                                                                                                                                                                                                                                                                |
