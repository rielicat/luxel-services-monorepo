...
| `booking_started`        | User lands on `/agendar` with a quote              | `service_slug`, `amount_clp`, `frequency`                                                                                                            | Book                 |
...
| `account_viewed`         | `/cuenta` rendered                                 | `has_subscription:bool`, `bookings_count`                                                                                                            | Retention            |
...
| `quote_started`                                  | `apps/web/src/app/[locale]/calculadora/calculator-form.tsx`                                                                               | Client                    |
| `quote_calculated`                               | `apps/web/src/app/[locale]/calculadora/actions.ts` (`getQuoteAction`, `ok` branch)                                                        | Server                    |
| `quote_out_of_area`                              | `apps/web/src/app/[locale]/calculadora/actions.ts` (`out_of_area` branch)                                                                 | Server                    |
| `booking_started`                                | `apps/web/src/app/[locale]/agendar/booking-form.tsx` (or `agendar/page.tsx`)                                                              | Client                    |
| `booking_created`                                | `apps/web/src/app/[locale]/agendar/actions.ts` (`createBookingAction`, after insert)                                                      | Server                    |
...
| `subscription_paused` / `subscription_cancelled` | `apps/web/src/app/[locale]/cuenta/actions.ts` (`setSubscriptionStatusAction`)                                                             | Server                    |
...
| `account_viewed`                                 | `apps/web/src/app/[locale]/cuenta/page.tsx`                                                                                               | Client (or server render) |
